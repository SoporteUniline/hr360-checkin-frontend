...
import { FileText, Pencil, Trash2, AlertTriangle, Save, SlidersHorizontal } from "lucide-react";
        ...
        */}
          ...
          <Form {...form}>
            ...
            <div className="bg-gradient-to-br from-purple-50 via-white to-fuchsia-50 border border-purple-100 rounded-xl p-5 space-y-4">
              <div className="flex items-center gap-2">
                ...
                <div className="font-semibold text-gray-900">Clasificación y gravedad</div>
              </div>
        ...
        <div className="pt-6 border-t">
          <div className="flex items-center justify-between gap-2 pb-2">
            <p className="font-semibold text-sm text-gray-900">Tipos existentes</p>
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-gray-50 hover:bg-gray-50">
                  <TableHead className="font-semibold text-gray-700 uppercase text-xs">Nombre</TableHead>
                  <TableHead className="font-semibold text-gray-700 uppercase text-xs">Clasificación</TableHead>
                  <TableHead className="font-semibold text-gray-700 uppercase text-xs">Gravedad</TableHead>
                  <TableHead className="font-semibold text-gray-700 uppercase text-xs text-right">Acciones</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                  ...
                  tiposOrdenados.map((tipo) => (
                    <TableRow key={tipo.id_tipo_acta}>
                      ...
                      <TableCell className="text-right">
                        <div className="flex justify-end items-center gap-2 min-w-[96px]">
                          <button
                            type="button"
        ...
        <AlertDialogContent className="sm:max-w-[425px] p-0">
          <AlertDialogHeader className="bg-gradient-to-r from-red-500 to-red-600 text-white p-6 rounded-t-lg">
            <div className="flex items-center gap-3">
              ...
              <AlertDialogTitle className="text-white">¿Eliminar tipo de acta?</AlertDialogTitle>
            </div>
          </AlertDialogHeader>
          ...
          <AlertDialogFooter className="bg-gray-50 p-4 flex justify-end gap-2 rounded-b-lg">
            <AlertDialogCancel className="border-gray-300" disabled={isSubmitting}>
              Cancelar
            </AlertDialogCancel>
            <AlertDialogAction
