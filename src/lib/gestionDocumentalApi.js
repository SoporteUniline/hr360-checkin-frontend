...
function buildTemplateFallback() {
  return [
    ...
    '  <div style="border:1px solid #e5e7eb;border-left:4px solid #7C3AED;border-radius:8px;padding:12px;background:#fafafa;margin:16px 0;">',
    '    <p style="margin:0 0 8px 0;font-weight:700;color:#7C3AED;">Datos del empleado</p>',
...
export const iaApi = {
  async generarPlantilla(payload) {
    ...
    const prompt = [
      ...
      "Usa colores de ADAMIA (#2563EB y #7C3AED) y estilo empresarial limpio.",
