    ...
    <div className="w-full">
      <div className="p-5 py-10 md:px-10 lg:px-30 xl:px-40">
        ...
        <div className="mt-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 min-h-40">
          <div className="rounded-md border border-gray-200 p-7 transition hover:-translate-y-1 hover:border-[var(--adamia-blue)]/40 hover:shadow-xl">
            <p className="text-center text-3xl">📋</p>
            <p className="text-center text-2xl font-extrabold text-[var(--adamia-text-primary)]">
              1,200+
            </p>
