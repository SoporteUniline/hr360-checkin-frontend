...
// function calcularMontoMensual(item) {
//   const precioFijo = Number(item?.precio_por_mes || 0);
//   const empleados = Number(item?.empleados || 0);
//   const precioEmpleado = Number(item?.precio_empleado_extra || 0);
//   const planLegacy = Number(item?.plan_precio_base || 0);

//   if (precioFijo > 0) return precioFijo;
//   if (empleados > 0 && precioEmpleado > 0) return empleados * precioEmpleado;
//   if (planLegacy > 0) return planLegacy;
...
//   const precioMensual = calcularMontoMensual(item);
...
//                     {item.precio_por_mes
//                       ? "Precio fijo"
//                       : item.empleados && item.precio_empleado_extra
//                       ? "Por empleado"
...
//                     {money(calcularMontoMensual(item))}
//                   </TableCell>
...
//           <div>
//             <label className="text-sm font-medium text-slate-700 mb-1 block">
//               Precio fijo mensual (opcional)
//             </label>
//             <Input
//               type="number"
//               min={0}
//               step="0.01"
//               placeholder="Dejar vacío para cobrar por empleado"
//               value={form.precio_por_mes}
//               onChange={set("precio_por_mes")}
//             />
//             <p className="text-xs text-slate-400 mt-1">
//               Si capturas este monto, será la mensualidad fija del cliente. Si
//               lo dejas vacío, se cobrará: empleados × costo por empleado.
//             </p>
//           </div>
