...
export default function DepartamentosTable({
  ...
  if (isLoading) {
    return (
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-10">
        <div className="text-center text-gray-500">Cargando departamentos...</div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-10">
        <div className="text-center text-red-500">Error al cargar departamentos</div>
      </div>
    );
  }
  ...
  if (departamentos.length === 0) {
    return (
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-10">
        <div className="text-center text-gray-500">No se encontraron departamentos.</div>
      </div>
    );
  }
