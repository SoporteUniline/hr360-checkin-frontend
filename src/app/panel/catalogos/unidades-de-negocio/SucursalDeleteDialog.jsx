...
export default function SucursalDeleteDialog({
  ...
  const confirmDelete = async () => {
    try {
      ...
      enqueueSnackbar("Unidad de negocio eliminada correctamente", {
        variant: "success",
      });
      await mutate(
      ...
      console.error("Error al eliminar unidad de negocio", err);
      enqueueSnackbar("Error al eliminar unidad de negocio", {
        variant: "error",
      });
    } finally {
      setOpen(false);
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-red-700">
                ¿Estás seguro que quieres eliminar esta unidad de negocio? Esta
