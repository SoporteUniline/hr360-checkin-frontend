      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mb-6">
        <div className="px-6 py-4 border-b border-gray-100 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">Consulta y corrige entradas/salidas.</p>
          </div>
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-gray-50 hover:bg-gray-50">
                ...
                <TableHead className="font-semibold text-gray-700 uppercase text-xs">Departamento / Sucursal</TableHead>
                {/* IMPORTANTE (UX): aunque filtremos 1 solo día (desde===hasta), siempre mostramos la fecha */}
                <TableHead className="font-semibold text-gray-700 uppercase text-xs text-center">Fecha de entrada</TableHead>
                <TableHead className="font-semibold text-gray-700 uppercase text-xs text-center">Hora entrada</TableHead>
                <TableHead className="font-semibold text-gray-700 uppercase text-xs text-center">Hora salida</TableHead>
